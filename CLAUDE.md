...
- Task 6 (Abschluss): dieser Commit — Bundle gemessen, `docs/domaenenmodell.md` geprüft (keine Änderung nötig, dieser Plan fasst kein DB-Schema an, letzte Migration bleibt `0007`), Status hier nachgezogen.
