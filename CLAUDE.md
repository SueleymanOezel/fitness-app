...
## Phase 4 – Körperbereich (gemerged, Manual-Verification offen)
...
**Nächster Schritt:** die manuelle Verifikation gegen Produktion — die Liste steht am Ende von `docs/superpowers/plans/2026-08-24-phase4-koerperbereich-plan.md`. Der wichtigste Punkt darin ist Schritt 4: ein zweiter Eintrag mit *früherem* Datum darf `profiles.aktuelles_gewicht` **nicht** verändern.
