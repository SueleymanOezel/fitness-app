...
## Phase 5 – Analysebereich (Plan 1, 2a, 2b und 2c gemerged; nur Plan 2c noch nicht gegen Produktion verifiziert)

### Sofort-Einstieg für einen neuen Chat

**Alle vier Pläne (1, 2a, 2b, 2c) sind gemerged.** Alle 19 geplanten Graphen aus Training (T1–T8), Ernährung (E1–E6) und Körper (K1–K5) existieren im Code — der Analysebereich ist damit vollständig auf `master`. Plan 1, 2a und 2b sind zusätzlich gegen Produktion manuell verifiziert; Plan 2c noch nicht.
...
5. **Plan 2c (Körper, K2–K5) ist gemerged über PR #39 (Squash-Merge-Commit `279e532`), Branch/Worktree entfernt.** Alle 8 Tasks einzeln abgenommen, danach Whole-Branch-Review auf Opus (kein Critical, ein Important — vier statt einer sequenziellen Abfrage im Körper-Hook — vor dem Merge per `Promise.all` behoben und sauber re-reviewt). Details siehe „Plan 2c" unten. **Noch offen:** manuelle Verifikation gegen Produktion.

**Genau hier weitermachen:**
Manuelle Verifikation von Plan 2c gegen Produktion (zehn Schritte im Plan unter „Manual Verification", `docs/superpowers/plans/2026-08-29-phase5-plan2c-koerpergraphen.md`) — braucht eine Datenlage mit Vorzeichenwechsel über zwei Wochen und mindestens zwei Fotos, eines davon an einem eintragslosen Tag; die synthetischen Plan-1-Zeilen decken das nur teilweise ab. Wiki ist bereits synchronisiert (siehe unten). Nach der Verifikation ist der Analysebereich vollständig abgeschlossen; danach kein Folge-Schritt für Phase 5 mehr offen — nächster Meilenstein wäre Phase 6 (Härtung), für die noch keine Spec/Plan existiert.
...
**Noch offen für diesen Plan:** die manuelle Verifikation gegen Produktion (Schritte im Plan unter „Manual Verification" — braucht eine Datenlage mit Vorzeichenwechsel über zwei Wochen und mindestens zwei Fotos, eines davon an einem eintragslosen Tag; die synthetischen Plan-1-Zeilen decken das nur teilweise ab).
