...
## Phase 5 – Analysebereich (Plan 1, 2a und 2b gemerged und verifiziert, Plan 2c offen)

### Sofort-Einstieg für einen neuen Chat

**Plan 1, 2a und 2b sind gemerged und gegen Produktion verifiziert.** Alle 19 geplanten Graphen aus Training (T1–T8) und Ernährung (E1–E6) stehen; nur Körper (K1 gemerged, K2–K5 aus Plan 2c) fehlt noch.
...
2. `TrainingChartList.tsx` ist der einzige Ort, an dem noch ein Trainingsgraph eingebunden wird, `NutritionChartList.tsx` das Analogon für Ernährung — beide Dashboard und Analyse-Seite, jeder Chart hinter `React.lazy`.
